                ...
                .. tab-set::
                    ...
                    .. tab-item:: Rebellions NPU
                        ...
                        .. code-block:: bash
                            ...
                            # Build LMCache with the RBLN backend. BUILD_WITH_RBLN=1 makes
                            # setup.py pick torch-rbln automatically; it pins torch==2.11.0+cpu,
                        ...
                        .. note::
                            ...
                            torch-rbln registers the ``rbln`` torch backend — without it
                            ``torch.rbln`` does not exist and the device is never detected.
                            The native ``lmcache.rbln_ops`` extension additionally links
                            ``librbln`` from the rebel-compiler installation;
